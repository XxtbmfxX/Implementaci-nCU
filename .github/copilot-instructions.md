...
- RBAC summary (also in `BAAS_HELP/sitemap-and-roles.md`): MEDICO: fichas+citas propias+pacientes; SECRETARIA: agenda+pacientes CRUD; GERENTE: dashboard+medicos CRUD+auditoría. Navigation and permissions follow this map.
